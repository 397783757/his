...
public class Allergic {
    private int id;
    private String name;
    private String x_wubi;
    private String x_pinyin;
    ...
    public void setX_wubi(String x_wubi) {
        this.x_wubi = x_wubi;
    }

    public String getX_pinyin() {
    ...
    public void setX_pinyin(String x_pinyin) {
        this.x_pinyin = x_pinyin;
    }
