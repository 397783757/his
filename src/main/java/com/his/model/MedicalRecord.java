...
public class MedicalRecord {
    ...
    private String nowill_description;
    private String historyill_description;
    private String personal_description;
    private String familyill_history;
    private String doctor_advice;
    private String allergic_note;
    ...
    private Icd_diagnosis[] icd_diagnosises;
    public String getWubi_code() {
        StringBuffer result = new StringBuffer();
        String str=getPartner_name().toString();
    ...
    public String getPinyin_code() {
        char[] t1  = getPartner_name().toCharArray();
    ...
    public String getPartner_name() {
        return partner_name==null?"":partner_name;
    }
    ...
    public Icd_diagnosis[] getIcd_diagnosises() {
        return icd_diagnosises;
    }

    public void setIcd_diagnosises(Icd_diagnosis[] icd_diagnosises) {
        this.icd_diagnosises = icd_diagnosises;
    }
    public String getMr_id() {
        return mr_id==null?"":mr_id;
    }

    public void setMr_id(String mr_id) {
        this.mr_id = mr_id;
    }
    public String getAllergic_note() {
        return allergic_note==null?"":allergic_note;
    }

    public void setAllergic_note(String allergic_note) {
        this.allergic_note = allergic_note;
    }

    public String getDoctor_advice() {
        return doctor_advice==null?"":doctor_advice;
    }
    ...
    public String getMain_description() {
        return main_description==null?"":main_description;
    }
    ...
    public String getNowill_description() {
        return nowill_description==null?"":nowill_description;
    }

    public void setNowill_description(String nowill_description) {
        this.nowill_description = nowill_description;
    }

    public String getHistoryill_description() {
        return historyill_description==null?"":historyill_description;
    }

    public void setHistoryill_description(String historyill_description) {
        this.historyill_description = historyill_description;
    }

    public String getPersonal_description() {
        return personal_description==null?"":personal_description;
    }
    ...
    public String getFamilyill_history() {
        return familyill_history==null?"":familyill_history;
    }

    public void setFamilyill_history(String familyill_history) {
        this.familyill_history = familyill_history;
    }



    public String getDiagnostic_type() {
        return diagnostic_type==null?"":diagnostic_type;
    }
    ...
    public String getPrescription_type() {
        return prescription_type==null?"":prescription_type;
    }
    ...
    public String getDoctor() {
        return doctor== null ? "" : doctor.trim();
    }
    ...
    public String getDoctor_licence() {
        return doctor_licence==null?"":doctor_licence;
    }

    public void setDoctor_licence(String doctor_licence) {
        this.doctor_licence = doctor_licence;
    }
    ...
    public String getReadme() {
        return readme== null ? "" : readme.trim();
    }
